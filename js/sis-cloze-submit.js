(function () {
  ...
  var CLOSE_BUTTON_HTML =
    '<button class="btn-74 hp-button hp-close-button tm1-5" type="button" data-hp-close aria-label="Close" aria-description="Close this exercise." data-hp-tooltip="Close this exercise.">Close</button>'
