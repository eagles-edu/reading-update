...
- Pages audited: 1446
- Pages passing every checklist item: 1445
...
| kidsenglish2 | `kidsenglish2/cloze/kecloze2075.html` | `output/playwright/cloze-integrity/kidsenglish2-kecloze2075-desktop.png` | `output/playwright/cloze-integrity/kidsenglish2-kecloze2075-mobile.png` |
| kidsenglish2 | `kidsenglish2/cloze/kecloze2100.html` | `output/playwright/cloze-integrity/kidsenglish2-kecloze2100-desktop.png` | `output/playwright/cloze-integrity/kidsenglish2-kecloze2100-mobile.png` |
| kidsenglish3 | `kidsenglish3/cloze/kecloze3001.html` | `output/playwright/cloze-integrity/kidsenglish3-kecloze3001-desktop.png` | `output/playwright/cloze-integrity/kidsenglish3-kecloze3001-mobile.png` |
| kidsenglish3 | `kidsenglish3/cloze/kecloze3026.html` | `output/playwright/cloze-integrity/kidsenglish3-kecloze3026-desktop.png` | `output/playwright/cloze-integrity/kidsenglish3-kecloze3026-mobile.png` |
...
### `essays/cloze/cloze100.html`

- **CL-01:** one body#TheBody. Observed: `{"count":0}`. Remediation: Repair the document body id before changing the cloze shell.
- **CL-02:** width=device-width and initial-scale=1. Observed: `{"content":null}`. Remediation: Add or correct the viewport meta tag.
- **CL-03:** one instruction panel with Titles > h1.ExerciseTitle and InstructionsDiv. Observed: `{"panels":0,"titles":0,"headings":0,"instructions":0}`. Remediation: Move the exercise title and instructions into the canonical instruction panel.
- **CL-04:** unique MainDiv/ClozeDiv/FeedbackDiv nested under the shell. Observed: `{"InstructionsDiv":0,"MainDiv":0,"ClozeDiv":0,"FeedbackDiv":0}`. Remediation: Repair duplicate or misplaced exercise blocks; do not fabricate missing exercise content.
...
- **CL-15:** source is not an HTTP error placeholder or duplicated document. Observed: `{"bytes":635,"errorPlaceholder":true,"duplicateHtmlEndings":false}`. Remediation: Recover the original exercise source or exclude this placeholder from modernization until its content is restored.
