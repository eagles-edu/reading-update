...
Malformed-source rule: restore a truncated exercise only from a verified complete source before modernization. HTTP 404 placeholders such as `essays/cloze/cloze100.html`, `essays/comp/comp100.html`, `begin1/sent/b1mx08905.html`, and `kidsenglish3/sent/kemx305582.html` remain `ACTION_REQUIRED` until their original exercise content is recovered; the modernizer must not invent answers, questions, or controls for them.
