function Client() {
    ...
    // Use User-Agent Client Hints
       this.name = navigator.userAgentData.brands.map(b => b.brand).join(', ');
       this.ver  = navigator.userAgentData.brands.map(b => b.version).join(', ');
   }
...
var DefaultWrong = 'Sorry! Please try again.';
var QsToShow = 5;
var Score = 0;
var Finished = false;
var Qs = null;
...
function ChangeQ( ChangeBy ) {
	...
	//question is answered correctly. Uncomment it to enable this behavior.
...
I[ 0 ][ 2 ] = '1';
I[ 0 ][ 3 ] = new Array();
I[ 0 ][ 3 ][ 0 ] = new Array( 'White is too boring.', '', 1, 100, 1 );
I[ 1 ] = new Array(); I[ 1 ][ 0 ] = 100;
I[ 1 ][ 1 ] = '';
I[ 1 ][ 2 ] = '1';
I[ 1 ][ 3 ] = new Array();
I[ 1 ][ 3 ][ 0 ] = new Array( 'Red is too daring.', '', 1, 100, 1 );
I[ 2 ] = new Array(); I[ 2 ][ 0 ] = 100;
I[ 2 ][ 1 ] = '';
I[ 2 ][ 2 ] = '1';
I[ 2 ][ 3 ] = new Array();
I[ 2 ][ 3 ][ 0 ] = new Array( 'Blue is too sad.', '', 1, 100, 1 );
I[ 3 ] = new Array(); I[ 3 ][ 0 ] = 100;
I[ 3 ][ 1 ] = '';
I[ 3 ][ 2 ] = '1';
I[ 3 ][ 3 ] = new Array();
I[ 3 ][ 3 ][ 0 ] = new Array( 'Yellow is too bright.', '', 1, 100, 1 );
I[ 4 ] = new Array(); I[ 4 ][ 0 ] = 100;
I[ 4 ][ 1 ] = '';
I[ 4 ][ 2 ] = '1';
I[ 4 ][ 3 ] = new Array();
I[ 4 ][ 3 ][ 0 ] = new Array( 'Green is perfect.', '', 1, 100, 1 );
...
var CorrectList = 'Correct answer: ';
...
function ReplaceGuessBox( QNum, Ans ) {
	if ( document.getElementById( 'Q_' + QNum + '_SA' ) != null ) {
		...
		A.setAttribute( 'class', 'Answer correct' );
